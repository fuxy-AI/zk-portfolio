(()=>{
function boot(){
document.querySelectorAll(':is(#selected,#district9,#croki,#gipsy-danger,#space-marine) .project-feature').forEach(card=>{
...
const galleries=[...document.querySelectorAll(':is(#selected,#district9,#croki,#gipsy-danger,#space-marine) .project-thumbs')];
